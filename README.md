...
├── pandas_basic/           # → pandas_basic/README.md
├── learn_streamlit/        # → learn_streamlit/README.md
└── python_basics/
...
- [pandas_basic/](firstPython/pandas_basic/README.md) — numpy 브로드캐스팅 규칙과 shape 비교 (작성 중)
- [learn_streamlit/](firstPython/learn_streamlit/README.md) — streamlit 가상환경(venv) 설정, requirements.txt 관리 (작성 중)
